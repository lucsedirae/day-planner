...
function checkWeather() {
    ...
    console.log(roundedLong);
    var queryURL = ("https://api.openweathermap.org/data/2.5/weather?lat="+roundedLat+"&lon="+roundedLong+"&appid=22ce314bdb5cf097792a93d02ec2e354");
    ...
    $.ajax({
        ...
        method: "GET"
            ...
            $("#currentWeather").text("Currently " + temperature + " degrees and " + skyState);
        }
)};
